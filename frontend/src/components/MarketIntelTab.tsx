...
function MarketIntelTabInner() {
  ...
  const fetchData = useCallback(async () => {
    // Save scroll position before updating data (chart re-renders reset scroll)
    ...
    try {
      ...
      // Restore scroll position after React re-renders and charts rebuild.
      // Double-rAF ensures the DOM has settled after useEffect chart creation.
...
export default memo(MarketIntelTabInner);
