    ...
    <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
      ...
      {hasSignal ? (
        <div className="p-6 space-y-6">
          ...
          {/* Concepts */}
          <div>
            <h3 className="font-medium mb-3">Smart Money Concepts Detected</h3>
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-gray-500 text-sm mt-2">
            ...
            Multiple Smart Money concepts must align for signal generation.
          </p>
        </div>
      )}
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">Full Smart Money methodology analysis with ML insights</p>
        </div>
      </div>
